  ...
  return (
    ...
    >
        ...
        <View style={styles.dots}>
          {[0, 1, 2, 3].map((i) => (
            <View
              ...
              style={[
                styles.dot,
                { backgroundColor: i <= 2 ? theme.gold : theme.border },
              ]}
            />
          ))}
        </View>
      ...
      >
        ...
        >
          We personalize your program from this.
        </Text>
            ...
            <View style={styles.unitToggle}>
              {(["cm", "ft"] as const).map((u) => (
                <TouchableOpacity
                  ...
                  testID={`height-unit-${u}`}
                  style={[
                    styles.unitBtn,
                    {
                      backgroundColor:
                        heightUnit === u ? theme.gold : theme.bgElevated,
                    },
                  ]}
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          heightUnit === u ? "#0A0A0A" : theme.textSecondary,
            ...
            <View style={styles.unitToggle}>
              {(["kg", "lbs"] as const).map((u) => (
                <TouchableOpacity
                  ...
                  testID={`weight-unit-${u}`}
                  style={[
                    styles.unitBtn,
                    {
                      backgroundColor:
                        weightUnit === u ? theme.gold : theme.bgElevated,
                    },
                  ]}
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          weightUnit === u ? "#0A0A0A" : theme.textSecondary,
                        fontFamily: FONTS.semiBold,
                      },
                    ]}
                  >
        ...
        <View style={styles.statSection}>
          ...
          <View style={styles.sliderRow}>
            <TouchableOpacity
              onPress={() => setSleep(Math.max(3, sleep - 1))}
              style={[styles.adjBtn, { borderColor: theme.border }]}
            >
              <Feather name="minus" size={16} color={theme.textSecondary} />
            </TouchableOpacity>
            ...
            <TouchableOpacity
              onPress={() => setSleep(Math.min(12, sleep + 1))}
              style={[styles.adjBtn, { borderColor: theme.border }]}
            >
              <Feather name="plus" size={16} color={theme.textSecondary} />
            </TouchableOpacity>
              ...
              {ACTIVITY_LEVELS.map((level) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        activity === level ? theme.gold : theme.bgElevated,
                    },
                  ]}
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          activity === level ? "#0A0A0A" : theme.textSecondary,
                        fontFamily: FONTS.semiBold,
                      },
                    ]}
                  >
