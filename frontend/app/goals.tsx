        ...
        <View style={styles.dots}>
          {[0, 1, 2, 3].map((i) => (
            <View
              ...
              style={[
                styles.dot,
                { backgroundColor: i === 0 ? theme.gold : theme.border },
              ]}
            />
          ))}
        </View>
      ...
      <FlatList
        ...
        renderItem={({ item: goal }) => {
          ...
          return (
            ...
            >
              {isSel && (
                <View
                  style={[styles.checkBadge, { backgroundColor: theme.gold }]}
                >
              ...
              <Feather
                ...
                size={28}
                color={isSel ? theme.gold : theme.textMuted}
              />
              <Text
                style={[
                  styles.goalLabel,
                  {
                    color: isSel ? theme.textPrimary : theme.textSecondary,
        ...
        ListFooterComponent={
          <TouchableOpacity
            ...
            testID="goals-agree-btn"
          >
            <View
              style={[
                styles.checkbox,
                {
                  borderColor: agreed ? theme.gold : theme.border,
                  backgroundColor: agreed ? theme.gold : "transparent",
                },
              ]}
            >
          ...
          onPress={async () => {
            ...
            try {
              if (session?.user) {
                await supabase
                  .from("profiles")
                  .update({ rank: selected, goals: [selected] })
