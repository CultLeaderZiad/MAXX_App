        ...
        { text: "Keep Pushing", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              const activeStreaks =
                profile?.streaks?.filter((s: any) => s.type !== "nofap") || [];
              activeStreaks.push({
                type: "nofap",
    ...
    >
      ...
      >
            ...
            return (
              ...
              >
                ...
                <Text
                  style={[
                    styles.msDays,
                    { color: unlocked ? theme.gold : theme.textMuted },
                  ]}
                >
                  {m.days} Days
                </Text>
        ...
        <View style={styles.actions}>
          ...
          >
            Relapsing is a choice. Winning is a habit.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
