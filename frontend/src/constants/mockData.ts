...
export const WEAK_SPOT_OPTIONS = [
  {
    key: "weak_jaw",
    label: "Weak jaw / no definition",
    icon: "frown" as const,
  },
  {
    key: "bad_posture",
    label: "Bad posture / hunched",
    icon: "align-center" as const,
  },
  {
    key: "low_energy",
    label: "Low energy / brain fog",
    icon: "battery" as const,
  },
  {
    key: "porn_habit",
    label: "Porn / masturbation habit",
    icon: "eye-off" as const,
  },
  {
    key: "no_confidence",
    label: "No confidence with girls",
